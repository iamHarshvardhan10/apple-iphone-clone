      ...
      <div className="screen-max-width">
          ...
          <div className="relative h-full flex-center">
            <div className="overflow-hidden">
              <img
                src={frameImg}
                alt="frame"
                className="bg-tranparent relative z-10"
              />
            </div>
        ...
        <div className="hiw-text-container">
          ...
          <div className="flex-1 flex justify-center flex-col g_fadeIn">
            <p className="hiw_text">New</p>
            <p className="text-white text-3xl md:text-5xl font-normal md:font-semibold my-2">Pro-class</p>
            <p className="hiw_text">with 6 cores</p>
          </div>
        </div>
      </div>
    </section>
